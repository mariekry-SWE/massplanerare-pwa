...
function parseCSV(text) {
    ...
    for (let i = 1; i < lines.length; i++) {
        ...
        inventory.push({
            id: i, // Unikt ID för att hantera sortering
...
function renderInventoryList() {
    ...
    // Sortera: Tillgängliga först, sedan slutsålda (och sedan alfabetiskt)
    inventory.sort((a, b) => {
...
function drawBoard() {
    ...
    // Använd skalning och panorering
    ...
    placedItems.forEach((item, idx) => {
        ...
        // Text: justera fontstorlek för skalning
        ctx.fillStyle = "#000";
...
canvas.addEventListener('mousedown', (e) => {
    ...
    // Testa om vi klickade på en utplacerad möbel
    selectedItemIndex = -1;
    ...
    // Om ingen möbel klickades, starta Panorering
    isPanning = true;
    lastPanX = e.clientX;
    lastPanY = e.clientY;
...
workspace.addEventListener('wheel', (e) => {
    ...
    // Panorering för att hålla bilden relativt stilla i centrum
...
// NYCKELHANTERING: DELETE/BACKSPACE och ROTERA (R)
